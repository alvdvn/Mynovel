...
import { View, Text, Image, FlatList, StyleSheet, SafeAreaView, TouchableOpacity, Button, ScrollView, SectionList } from "react-native";
...
const ListComposed = (props) => {

    const [listNovelUpdate, SetListNovelUpdate] = useState(ListNovel);
    const [SelectedID, SetSelectID] = useState(null)
    const Description = 'Đây là truyện do độc giả đăng tải lên \n'
        + 'ứng dụng \n'
    ...
    const SecstionHeader = () => {
        return(
            <View style={styles.contanerDes}>
                <Text style={styles.textDescription}>{Description}</Text>
                <TouchableOpacity style={styles.buttonComposed}>
                    <Text style={{ color: '#ffffff' }}>Sáng tác truyện</Text>
                </TouchableOpacity>
            </View>
        )
    }
    return (
        <SafeAreaView style={styles.containerListNovel}>
            
            <FlatList 
                ListHeaderComponent={SecstionHeader}
